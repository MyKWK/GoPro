...
type Product struct {
	...
	OriginalPrice int64  `gorm:"column:OriginalPrice" json:"OriginalPrice" imooc:"OriginalPrice" sql:"OriginalPrice"`
	NewPrice      int64  `gorm:"column:NewPrice" json:"NewPrice" imooc:"NewPrice" sql:"NewPrice"`
}
